...
### Bottom line
- Trust mechanisms, not just p‑values: The model that uses the true drivers (Stress and Time) is stable and interpretable; proxy‑based models can achieve similar R² while telling the wrong causal story. For decisions, use the joint model with real Stress; treat StressSurvey as a noisy indicator.
